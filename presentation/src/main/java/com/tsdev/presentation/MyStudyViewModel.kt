...
class MyStudyViewModel : BaseViewModel() {
    ...
    private val _bookmarkStudyList = MutableLiveData<List<DomainMyStudyResponse>>()

    val bookmarkStudyList: LiveData<List<DomainMyStudyResponse>>
        get() = _bookmarkStudyList
    ...
    init {
        ...
        _bookmarkStudyList.value = listOf(
            DomainMyStudyResponse(
                "피그마 스터디",
                "동작구",
                "토, 일",
